...
```{r latency-wa-ex}
#| echo: false
x_dt_with_diff = dv_wa$DT |> mutate(version_time_diff = version - time_value) |>
  select.list(geo_value, time_value, version, percent_cli, version_time_diff)
...
#| eval: false
library(epidatr)
hhs_flu_nc <- pub_covidcast('hhs', 'confirmed_admissions_influenza_1d', 'state', 'day', geo_values = 'nc',
