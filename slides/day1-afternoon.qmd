...
ggplot() + 
  ...
  geom_line(data = first_avail, aes(x = time_value, y = mortality, color = "First available issue")) +
  geom_point(data = first_avail, aes(x = time_value, y = mortality, color = "First available issue"), shape = 16) +
